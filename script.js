...
function rotateCube(x, y) {
    ...
    let Xvalue = Math.floor(x / 1.5 - 430)
    let Yvalue = Math.floor(y / 1.5 - 202)
...
function atualizarPeças() {
    ...
    midNode = document.querySelectorAll('.b4,.b5,.b6')
...
let LEFTbottomDirection = LEFTupDirection.slice().reverse();
